            ...
            <>
                <div className='position-fixed iconsDiv d-flex flex-column' style={{ width: '10rem' }} >
                    {this.Icons.map(({id , icon , text , link}) =>{
                        return(
                            <>
                           <li key={id} className='icons text-white fs-5 my-1 d-flex justify-content-end py-1 rounded-pill bg-dark' style={{listStyle:"none" , cursor:'pointer' }}> 
                           <a href={link} className='text-decoration-none text-white'>{text}
                           </a>
                           <span className='fs-3 d-flex align-items-center px-3'>
                            {icon}
                            </span>
                            </li>
                            </>
